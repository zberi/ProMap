...
function cortexEvaluate() {
  ...
  CORTEX.lastReport = { cosoResults, overallCoso, riskFlags, totalSteps, controlSteps, ccpSteps, monitoredSteps, recordedSteps, classifiedSteps, healthScore, process: State.currentProcess, generatedAt: new Date(), stepNumberMap, ctrlNumberMap };
